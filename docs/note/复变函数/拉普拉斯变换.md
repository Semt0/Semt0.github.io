...
!!! abstract "性质 5（像函数的积分）"
    若 $\lim_{t \to 0^+} \frac{f(t)}{t}$ 存在，则
...
!!! abstract "性质 10（卷积定理）"
    ...
    $$
    \mathcal{L}^{-1}[F_1(s) \cdot F_2(s)] = (f_1 * f_2)(t)
    $$
